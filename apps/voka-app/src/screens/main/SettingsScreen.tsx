        ...
        <SafeAreaView className="flex-1 bg-background pt-4">
            ...
            <View className="px-6 mb-6 flex-row items-center justify-between">
                <TouchableOpacity onPress={() => navigation.goBack()} className="p-2 -ml-2">
                    <Ionicons name="arrow-back" size={28} color="#8B949E" />
                </TouchableOpacity>
                <Text className="text-text-primary text-xl font-nunito font-bold">Settings</Text>
                <View className="w-10" />
            </View>

            <ScrollView className="flex-1 px-6" showsVerticalScrollIndicator={false}>

                <Text className="text-text-primary font-poppins font-semibold text-lg mb-4">Account</Text>
                ...
                <TouchableOpacity
                    onPress={signOut}
                    className="flex-row items-center justify-center p-4 rounded-xl bg-error/10 mb-8 mt-4"
                >
